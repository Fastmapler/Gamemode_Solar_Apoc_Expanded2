//sounds
datablock AudioProfile(assaultRifleFireLoopSound)
{
   filename    = "./Sounds/Fire/New/AssaultRifleFireLoop.wav";
   description = BAADFireLoop3D;
   preload = true;
};
datablock AudioProfile(assaultRifleFireEndSound)
{
   filename    = "./Sounds/Fire/New/MediumLoopEnd.wav";
...
{
   filename    = "./Sounds/Fire/assaultRifle.wav";
   description = AudioDefault3d;
   preload = true;
};

datablock DebrisData(assaultRifleClipDebris)
{
	shapeFile = "./shapes/weapons/AssaultRifleMag.dts";
	lifetime = 2.0;
	minSpinSpeed = 700.0;
	maxSpinSpeed = 800.0;
	elasticity = 0.5;
...
datablock ExplosionData(assaultRifleClipExplosion)
{
	debris 					= assaultRifleClipDebris;
	debrisNum 				= 1;
	debrisNumVariance 		= 0;
	debrisPhiMin 			= 0;
	debrisPhiMax 			= 360;
...
datablock ProjectileData(assaultRifleClipProjectile)
{
	explosion = assaultRifleClipExplosion;
};

//muzzle flash effects
datablock ProjectileData(assaultRifleProjectile1 : gunProjectile)
{
   directDamage        = 30;//8;
...
datablock ProjectileData(assaultRifleProjectile2 : assaultRifleProjectile1)
{
   sound = BAADWhiz2Sound;
};

datablock ProjectileData(assaultRifleProjectile3 : assaultRifleProjectile1)
{
...
datablock ItemData(assaultRifleItem)
{
   ...
   shapeFile = "./shapes/weapons/AssaultRifle.dts";
   rotate = false;
   mass = 1;
   density = 0.2;
   elasticity = 0.2;
...
function assaultRifleImage::onUnMount( %this, %obj, %slot )
{
...
function assaultRifleImage::onAmmoCheck( %this, %obj, %slot )
{hl2AmmoCheck(%this,%obj,%slot); hl2DisplayAmmo(%this,%obj,%slot);}

  /////// reload functions
function assaultRifleImage::onReloadStart( %this, %obj, %slot )
{
   hl2DisplayAmmo(%this,%obj,%slot);
}

function assaultRifleImage::onReload( %this, %obj, %slot )
{
   hl2AmmoOnReload(%this,%obj,%slot); 
   hl2DisplayAmmo(%this,%obj,%slot);
}

function assaultRifleImage::onEmptyFire( %this, %obj, %slot )
{
	if(%obj.isPlayingLoopingAudio[%this,%slot+1])
	{
		%obj.isPlayingLoopingAudio[%this,%slot+1] = 0;
...
function assaultRifleImage::onUntrig( %this, %obj, %slot )
{
	if(%obj.isPlayingLoopingAudio[%this,%slot+1])
	{
		%obj.isPlayingLoopingAudio[%this,%slot+1] = 0;
...
function assaultRifleImage::onEmpty(%this,%obj,%slot)
{
...
function assaultRifleImage::onFire( %this, %obj, %slot )
{
   ...
   hl2DisplayAmmo(%this,%obj,%slot);
    ...
    %projectiles = "assaultRifleProjectile1" TAB "assaultRifleProjectile2" TAB "assaultRifleProjectile3";
   ...
   if(!%obj.isPlayingLoopingAudio[%this,%slot+1])
   {
    	%obj.playAudio(%slot+1,AssaultRifleFireLoopSound);
...
function assaultRifleProjectile1::damage( %this, %obj, %col, %fade, %pos, %normal ){   %damage = %this.directDamage;   %headshot = matchBodyArea( getHitbox( %obj, %col, %pos ), $headTest );   if ( %headshot )   {      %damage *= %this.headshotMultiplier;   }   %col.damage( %obj, %pos, %damage, %this.directDamageType );}
function assaultRifleProjectile2::damage( %this, %obj, %col, %fade, %pos, %normal ){   %damage = %this.directDamage;   %headshot = matchBodyArea( getHitbox( %obj, %col, %pos ), $headTest );   if ( %headshot )   {      %damage *= %this.headshotMultiplier;   }   %col.damage( %obj, %pos, %damage, %this.directDamageType );}
function assaultRifleProjectile3::damage( %this, %obj, %col, %fade, %pos, %normal ){   %damage = %this.directDamage;   %headshot = matchBodyArea( getHitbox( %obj, %col, %pos ), $headTest );   if ( %headshot )   {      %damage *= %this.headshotMultiplier;   }   %col.damage( %obj, %pos, %damage, %this.directDamageType );}

function assaultRifleImage::OnClipRemoved(%this, %obj, %slot)
{
          ...
          %p = new projectile()
          {
              datablock = "assaultRifle" @ (%obj.toolAmmo[%obj.currTool] <= 0 ? "Clip" : "") @ "Projectile";
              initialPosition = vectorAdd(%obj.getSlotTransform(0),vectorRelativeShift(%forward,%up,"0.4 0 -0.5"));
          };
          %p.explode();
}

function assaultRifleImage::OnReloadB(%this, %obj, %slot) 
{
...
function assaultRifleImage::OnReloadC(%this, %obj, %slot)
{
